        ...
        <LoadingContainer>
          <Router>
            <MyContainer drizzle={drizzle} drizzleState={drizzleStore}>
              ...
              <Route exact path="/about" component={(props) => <About {...props} drizzle={drizzle} drizzleState={drizzleStore} />} />
              ...
              <Route exact path="/create-item" component={(props) => <AddItem {...props} drizzle={drizzle} drizzleState={drizzleStore} />} />
            </MyContainer>
          </Router>
        </LoadingContainer>
      </DrizzleProvider>
